...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar').on('click', 'li > a', function (e) {
             ...
             * TODO:170
             * 样式修正
             * keepExpand设置为false第一个菜单收缩有点问题
             */
            menu.children('li.active').removeClass('active');
            menu.children('arrow.open').removeClass('open');
        ...
        $('.top-menu').on('click', ' a.ajaxify', function (e) {
        	e.preventDefault();
            Metronic.scrollTop();
    ...
    var handleFixedSidebarHoverEffect = function () {
         ...
         */
        $('.page-sidebar .page-sidebar-menu > li > a').on('mouseenter', function () {
            if (body.hasClass('page-sidebar-closed')) {
                $(this).tooltip('show');
            }else{
                $(this).tooltip('hide');
            ...
            if (body.find('.page-sidebar-menu').hasClass('page-sidebar-menu-closed')) {
